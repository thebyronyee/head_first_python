...
def get_worlds(distance, stroke):
    """Given an event distance and stroke, return list of four
    world records."""
...
def perform_conversions(times):
    """Given list of swim times as strings, return the average time as a string,
    as well as reversed list of times and list of scaled swim times as 
    numbers (floats)"""
    converts = []
    for t in times:
